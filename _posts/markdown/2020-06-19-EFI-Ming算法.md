...
![事务数据库]({{ "/assets/algorithm/EFI-Mining算法/transaction database.png" | absolute_url }})

![扩展效用值]({{ "/assets/algorithm/EFI-Mining算法/External utility values.png" | absolute_url }})

![高效效用值项集]({{ "/assets/algorithm/EFI-Mining算法/High-Utility itemsets.png" | absolute_url }})

![枚举树]({{ "/assets/algorithm/EFI-Mining算法/Set-enumeration tree.png" | absolute_url }})
...
![propose_algorithm_1]({{ "/assets/algorithm/EFI-Mining算法/算法实现_1.png" | absolute_url }})

![propose_algorithm_2]({{ "/assets/algorithm/EFI-Mining算法/算法实现_2.png" | absolute_url }})
