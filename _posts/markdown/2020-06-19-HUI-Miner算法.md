...
![数据库存储数据](D:\资料\Sci_Research\EBooks\数据挖掘\paper\utility Mining\image\HUI-miner算法\DataBase.png)

$I = {\{i_1, i_2, \dots, i_n\}}$ 每个$i$在效用表($utility \; table$)中都存在对应的效用值($utility \; value$)

$X$是关于$i$的集合，叫效用集

![交易效用表](D:\资料\Sci_Research\EBooks\数据挖掘\paper\utility Mining\image\HUI-miner算法\Transaction Utility.png)
...
![交易权重效用表](D:\资料\Compile\EBooks\数据挖掘\image\HUI-miner算法\Transaction-Weighted Utility.png)
...
![s's](D:\资料\Sci_Research\EBooks\数据挖掘\paper\utility Mining\image\HUI-miner算法\DataBase View.png)
...
<img src="D:\资料\Sci_Research\EBooks\数据挖掘\paper\utility Mining\image\HUI-miner算法\Initial Utility-Lists.png" alt="初始化的效用列表" style="zoom:80%;" />
...
<img src="D:\资料\Sci_Research\EBooks\数据挖掘\paper\utility Mining\image\HUI-miner算法\Constructing Utility-Lists of 2-Itemsets.png" alt="构造二元效用列表项集" style="zoom:80%;" />
...
![多元效用表](D:\资料\Sci_Research\EBooks\数据挖掘\paper\utility Mining\image\HUI-miner算法\Utility-Lists of 3-Itemsets.png)

下面是求多元效用表伪代码：
<img src="D:\资料\Sci_Research\EBooks\数据挖掘\paper\utility Mining\image\HUI-miner算法\求多元效用表伪代码.png" alt="求多元效用表伪代码" style="zoom:50%;" />
...
<img src="D:\资料\Sci_Research\EBooks\数据挖掘\paper\utility Mining\image\HUI-miner算法\Set-Enumeration Tree.png" alt="枚举树" style="zoom: 67%;" />
...
<img src="D:\资料\Compile\EBooks\数据挖掘\image\HUI-miner算法\HUI-miner算法.png" alt="HUI-miner算法" style="zoom:50%;" />

同时为了提高效率，减少对效用列表的扫描次数，集合枚举树中一个节点的所有子节点所代表的项集具有相同的前缀项集。为此，我们将扩展项与前缀项分开存储，Fig.7(b)中的表可以构造成如下图结构：

<img src="D:\资料\Sci_Research\EBooks\数据挖掘\paper\utility Mining\image\HUI-miner算法\Utility-List Implementation.png" alt="效用列表工具" style="zoom:67%;" />
